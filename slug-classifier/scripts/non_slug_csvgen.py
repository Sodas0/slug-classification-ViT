'''
csv_gen.py: The purpose of thie module is to create CSV files for use with the download_images.py module. 

Creates 2 files: 
    1. slugs.csv:       Fetches images of slugs where there are at least 200 different images, to be saved into subfolders of individual species for training.
    2. nonslugs.csv:    Fetches images of creatures that are similar to slugs, to be funneled into a negative examples class.
...
class INaturalistCSVGenerator:
    def __init__(self, output_file="SCRIPT_TESTING.csv", total_images=300):
        """
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output', '-o', default='SCRIPT_TESTING.csv', 
